...
export default function Navbar() {
  ...
  const handleDonate = (amount) => {
    ...
    window.location.href = "https://flutterwave.com/pay/demo"; // Replace with real checkout link
  };
        ...
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-4 py-2 bg-orange-500 text-white rounded-full shadow hover:scale-105 hover:bg-orange-600 transition"
            >
              Request Training
            </button>
            <button
              onClick={() => setModal("volunteer")}
              className="px-4 py-2 border border-orange-500 text-orange-500 rounded-full shadow hover:scale-105 hover:bg-orange-50 transition hidden md:inline-block"
            >
              Volunteer
            </button>
            <button
              onClick={() => setModal("donate")}
              className="px-4 py-2 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-full shadow hover:scale-105 transition"
            >
              Donate
            </button>
          </div>
